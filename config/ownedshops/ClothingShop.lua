return {
	[1] = {
		--groups = 'ClothingShop',
		moneytype = 'money',
		label = 'Clothing Shop', -- identifier for each stores. do not rename once player already buy this store
		coord = vec3(130.57, -1977.93, 18.5), -- owner manage coord vec3(130.57, -1977.93, 18.5)
